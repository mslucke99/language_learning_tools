...
import 'grammar_entry_editor_screen.dart';
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => GrammarEntryEditorScreen(
                            entry: GrammarBookEntry.fromJson(entry),
                          ),
                        ),
                      ).then((_) => _loadEntries());
                    },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const GrammarEntryEditorScreen(entry: null),
            ),
          ).then((_) => _loadEntries());
        },
        child: const Icon(Icons.add),
        tooltip: 'Add Grammar Entry',
      ),
    );
  }
}
