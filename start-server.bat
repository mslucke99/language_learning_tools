...
echo Stop: start-server.bat kill
echo.
powershell -ExecutionPolicy Bypass -File manage-server.ps1 server-bg
goto end

:kill
echo Stopping API server...
powershell -ExecutionPolicy Bypass -File manage-server.ps1 kill
goto end
